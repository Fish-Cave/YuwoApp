...
const tabBar = {
  color: "#000000",
  selectedColor: "rgba(255, 141, 26, 1)",
  list: [
    {
      pagePath: "pages/index/index",
      text: "预约",
      iconPath: "/static/icon/user-add.png",
      selectedIconPath: "/static/icon/user-add-solid.png"
    },
    {
      pagePath: "pages/signIn/signIn",
      text: "签到",
      iconPath: "/static/icon/home.png",
      selectedIconPath: "/static/icon/home-solid.png"
    },
    {
      pagePath: "pages/user/user",
      text: "我的",
      iconPath: "/static/icon/shopping-cart.png",
      selectedIconPath: "/static/icon/shopping-cart-solid.png"
    }
  ]
};
const pagesJson = {
