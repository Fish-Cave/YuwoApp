				...
				<view class="timeline-container">
					...
					<view class="timeline-bar">
						<view
							...
							:style="calculateTotalTimelineStyle(reservation, startTime, endTime)"
						></view>
					</view>
				</view>
			</view>
...
.icon-container {
	...
	align-items: center;
	background: linear-gradient(135deg, #FFC107 0%, #FF9800 100%); /* 黄色主题 */
	width: 60px;
	height: 60px;
	border-radius: 16px;
	margin-right: 16px;
...
.machine-price {
	...
	font-weight: 500;
	padding: 4px 10px;
	background: rgba(255, 193, 7, 0.1); /* 黄色主题 */
	border-radius: 12px;
